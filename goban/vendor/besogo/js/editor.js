besogo.makeEditor = function(sizeX, sizeY) {
    ...
    // Removes current branch from the tree (with confirm)
    function cutCurrent() {
    ...
    // Removes the current node when it is a leaf (no confirm).
    // Nodes with children must use cutCurrent (Cut tool) instead.
